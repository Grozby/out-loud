...
public class ObjectReader4<T> extends ObjectReaderAdapter<T> {
   ...
   ObjectReader4(
      ...
      this(objectClass, null, null, features, schema, creator, buildFunction, fieldReader0, fieldReader1, fieldReader2, fieldReader3);
   }
   ...
   public FieldReader getFieldReader(long hashCode) {
      if (hashCode == this.hashCode0) {
         ...
         return hashCode == this.hashCode3 ? this.fieldReader3 : null;
      }
   }
   ...
   public FieldReader getFieldReaderLCase(long hashCode) {
      if (hashCode == this.hashCode0LCase) {
         ...
         return hashCode == this.hashCode3LCase ? this.fieldReader3 : null;
      }
   }
}
