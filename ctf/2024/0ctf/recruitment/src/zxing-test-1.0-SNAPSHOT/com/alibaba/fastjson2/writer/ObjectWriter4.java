...
public class ObjectWriter4<T> extends ObjectWriterAdapter<T> {
   ...
   public ObjectWriter4(Class<T> objectClass, String typeKey, String typeName, long features, List<FieldWriter> fieldWriters) {
   ...
   public final FieldWriter getFieldWriter(long hashCode) {
      if (hashCode == this.fieldWriter0.hashCode) {
         ...
         return hashCode == this.fieldWriter3.hashCode ? this.fieldWriter3 : null;
      }
   }
}
