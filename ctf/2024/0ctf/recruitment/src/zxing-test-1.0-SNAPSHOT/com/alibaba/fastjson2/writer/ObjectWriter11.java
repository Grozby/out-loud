...
public class ObjectWriter11<T> extends ObjectWriterAdapter<T> {
   ...
   public ObjectWriter11(Class<T> objectClass, String typeKey, String typeName, long features, List<FieldWriter> fieldWriters) {
   ...
   public final FieldWriter getFieldWriter(long hashCode) {
      if (hashCode == this.fieldWriter0.hashCode) {
         ...
         return hashCode == this.fieldWriter10.hashCode ? this.fieldWriter10 : null;
      }
   }
}
