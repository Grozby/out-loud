...
public class ObjectReader3<T> extends ObjectReaderAdapter<T> {
   ...
   ObjectReader3(
      ...
      this(objectClass, null, null, features, schema, creator, buildFunction, fieldReader0, fieldReader1, fieldReader2);
   }

   public ObjectReader3(
   ...
   public ObjectReader3(
      ...
      this.hasDefaultValue = this.fieldReader0.defaultValue != null || this.fieldReader1.defaultValue != null || this.fieldReader2.defaultValue != null;
   }
   ...
   public FieldReader getFieldReader(long hashCode) {
      if (hashCode == this.hashCode0) {
         ...
         return hashCode == this.hashCode2 ? this.fieldReader2 : null;
      }
   }
   ...
   public FieldReader getFieldReaderLCase(long hashCode) {
      if (hashCode == this.hashCode0LCase) {
         ...
         return hashCode == this.hashCode2LCase ? this.fieldReader2 : null;
      }
   }
}
