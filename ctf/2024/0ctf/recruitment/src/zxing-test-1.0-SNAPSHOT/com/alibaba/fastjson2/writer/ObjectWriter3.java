...
public class ObjectWriter3<T> extends ObjectWriterAdapter<T> {
   ...
   public ObjectWriter3(Class<T> objectClass, String typeKey, String typeName, long features, List<FieldWriter> fieldWriters) {
   ...
   public final FieldWriter getFieldWriter(long hashCode) {
      if (hashCode == this.fieldWriter0.hashCode) {
         ...
         return hashCode == this.fieldWriter2.hashCode ? this.fieldWriter2 : null;
      }
   }
}
