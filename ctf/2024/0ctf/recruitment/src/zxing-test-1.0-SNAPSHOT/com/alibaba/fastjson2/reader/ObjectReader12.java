...
public class ObjectReader12<T> extends ObjectReaderAdapter<T> {
   ...
   public ObjectReader12(
      ...
      this.hashCode11 = this.fieldReader11.fieldNameHash;
      ...
      this.hashCode11LCase = this.fieldReader11.fieldNameHashLCase;
   }
   ...
   public FieldReader getFieldReader(long hashCode) {
      ...
      } else if (hashCode == this.hashCode10) {
         return this.fieldReader10;
      } else {
         return hashCode == this.hashCode11 ? this.fieldReader11 : null;
      }
   }
   ...
   public FieldReader getFieldReaderLCase(long hashCode) {
      if (hashCode == this.hashCode0LCase) {
         ...
         return this.fieldReader9;
      } else if (hashCode == this.hashCode10LCase) {
         return this.fieldReader10;
      } else {
         return hashCode == this.hashCode11LCase ? this.fieldReader11 : null;
      }
   }
}
