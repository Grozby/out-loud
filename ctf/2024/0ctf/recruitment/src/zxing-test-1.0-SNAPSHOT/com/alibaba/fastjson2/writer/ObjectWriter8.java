...
public class ObjectWriter8<T> extends ObjectWriterAdapter<T> {
   ...
   public ObjectWriter8(Class<T> objectClass, String typeKey, String typeName, long features, List<FieldWriter> fieldWriters) {
   ...
   public final FieldWriter getFieldWriter(long hashCode) {
      if (hashCode == this.fieldWriter0.hashCode) {
         ...
         return hashCode == this.fieldWriter7.hashCode ? this.fieldWriter7 : null;
      }
   }
}
