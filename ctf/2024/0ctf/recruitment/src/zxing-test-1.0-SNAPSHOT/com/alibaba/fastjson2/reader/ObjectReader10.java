...
public class ObjectReader10<T> extends ObjectReaderAdapter<T> {
   ...
   public FieldReader getFieldReader(long hashCode) {
      if (hashCode == this.hashCode0) {
         ...
         return hashCode == this.hashCode9 ? this.fieldReader9 : null;
      }
   }
   ...
   public FieldReader getFieldReaderLCase(long hashCode) {
      if (hashCode == this.hashCode0LCase) {
         ...
         return hashCode == this.hashCode9LCase ? this.fieldReader9 : null;
      }
   }
}
