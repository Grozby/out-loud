...
public class ObjectWriter5<T> extends ObjectWriterAdapter<T> {
   ...
   public ObjectWriter5(Class<T> objectClass, String typeKey, String typeName, long features, List<FieldWriter> fieldWriters) {
   ...
   public final FieldWriter getFieldWriter(long hashCode) {
      if (hashCode == this.fieldWriter0.hashCode) {
         ...
         return hashCode == this.fieldWriter4.hashCode ? this.fieldWriter4 : null;
      }
   }
}
