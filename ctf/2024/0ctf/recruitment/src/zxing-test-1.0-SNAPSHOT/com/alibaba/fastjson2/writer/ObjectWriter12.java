...
public class ObjectWriter12<T> extends ObjectWriterAdapter<T> {
   ...
   public ObjectWriter12(Class<T> objectClass, String typeKey, String typeName, long features, List<FieldWriter> fieldWriters) {
   ...
   public final FieldWriter getFieldWriter(long hashCode) {
      ...
      } else if (hashCode == this.fieldWriter9.hashCode) {
         return this.fieldWriter9;
      } else if (hashCode == this.fieldWriter10.hashCode) {
         return this.fieldWriter10;
      } else {
         return hashCode == this.fieldWriter11.hashCode ? this.fieldWriter11 : null;
      }
   }
}
