...
public class ObjectWriter9<T> extends ObjectWriterAdapter<T> {
   ...
   public ObjectWriter9(Class<T> objectClass, String typeKey, String typeName, long features, List<FieldWriter> fieldWriters) {
   ...
   public final FieldWriter getFieldWriter(long hashCode) {
      if (hashCode == this.fieldWriter0.hashCode) {
         ...
         return hashCode == this.fieldWriter8.hashCode ? this.fieldWriter8 : null;
      }
   }
}
