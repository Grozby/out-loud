...
public class ObjectReader6<T> extends ObjectReaderAdapter<T> {
   ...
   ObjectReader6(
      ...
      this(
         objectClass, null, null, features, schema, creator, buildFunction, fieldReader0, fieldReader1, fieldReader2, fieldReader3, fieldReader4, fieldReader5
      );
   }
   ...
   public ObjectReader6(
      ...
      this.hasDefaultValue = this.fieldReader0.defaultValue != null
         ...
         || this.fieldReader5.defaultValue != null;
   }
               ...
               if (entryCnt > 2) {
                  ...
                  if (entryCnt > 3) {
                     ...
                     if (entryCnt > 4) {
                        ...
                        if (entryCnt > 5) {
                           this.fieldReader5.readFieldValue(jsonReader, objectx);
   ...
   public FieldReader getFieldReader(long hashCode) {
      if (hashCode == this.hashCode0) {
         ...
         return hashCode == this.hashCode5 ? this.fieldReader5 : null;
      }
   }
   ...
   public FieldReader getFieldReaderLCase(long hashCode) {
      if (hashCode == this.hashCode0LCase) {
         ...
         return hashCode == this.hashCode5LCase ? this.fieldReader5 : null;
      }
   }
}
