...
public class PNMMetadata extends IIOMetadata implements Cloneable {
   ...
   PNMMetadata() {
      super(true, "com_sun_media_imageio_plugins_pnm_image_1.0", "com.github.jaiimageio.impl.plugins.pnm.PNMMetadataFormat", null, null);
   }
            ...
            if (!name.equals("Data")) {
               if (!name.equals("Dimension") && !name.equals("Document")) {
                  if (name.equals("Text")) {
                     ...
                     for (int jx = 0; jx < children1.getLength(); jx++) {
                        Node child = children1.item(jx);
                        String name1 = child.getNodeName();
               ...
               for (int jxx = 0; jxx < children1.getLength(); jxx++) {
                  Node child = children1.item(jxx);
                  String name1 = child.getNodeName();
