...
public class BMPMetadataFormatResources extends ListResourceBundle {
   ...
   protected Object[][] getContents() {
      return new Object[][]{
         ...
         {"ColorsUsed", "Number of color indexes in the color table actually used"},
         {"ColorsImportant", "Number of color indexes considered important for display"},
         {"Mask", "Color masks; present for BI_BITFIELDS compression only"},
