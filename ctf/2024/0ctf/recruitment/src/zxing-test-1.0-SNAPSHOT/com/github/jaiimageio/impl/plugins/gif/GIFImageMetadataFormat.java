...
public class GIFImageMetadataFormat extends IIOMetadataFormatImpl {
   ...
   private GIFImageMetadataFormat() {
      ...
      this.addAttribute("ImageDescriptor", "imageLeftPosition", 2, true, null, "0", "65535", true, true);
      this.addAttribute("ImageDescriptor", "imageTopPosition", 2, true, null, "0", "65535", true, true);
      ...
      this.addAttribute("LocalColorTable", "sizeOfLocalColorTable", 2, true, null, Arrays.asList(GIFStreamMetadata.colorTableSizes));
      ...
      this.addAttribute("GraphicControlExtension", "disposalMethod", 0, true, null, Arrays.asList(GIFImageMetadata.disposalMethodNames));
      ...
      this.addAttribute("GraphicControlExtension", "delayTime", 2, true, null, "0", "65535", true, true);
      this.addAttribute("GraphicControlExtension", "transparentColorIndex", 2, true, null, "0", "255", true, true);
      this.addElement("PlainTextExtension", "javax_imageio_gif_image_1.0", 0);
      this.addAttribute("PlainTextExtension", "textGridLeft", 2, true, null, "0", "65535", true, true);
      this.addAttribute("PlainTextExtension", "textGridTop", 2, true, null, "0", "65535", true, true);
      this.addAttribute("PlainTextExtension", "textGridWidth", 2, true, null, "1", "65535", true, true);
      this.addAttribute("PlainTextExtension", "textGridHeight", 2, true, null, "1", "65535", true, true);
      this.addAttribute("PlainTextExtension", "characterCellWidth", 2, true, null, "1", "65535", true, true);
      this.addAttribute("PlainTextExtension", "characterCellHeight", 2, true, null, "1", "65535", true, true);
      this.addAttribute("PlainTextExtension", "textForegroundColor", 2, true, null, "0", "255", true, true);
      this.addAttribute("PlainTextExtension", "textBackgroundColor", 2, true, null, "0", "255", true, true);
      ...
      this.addAttribute("ApplicationExtension", "applicationID", 0, true, null);
      this.addAttribute("ApplicationExtension", "authenticationCode", 0, true, null);
      this.addObjectValue("ApplicationExtension", byte.class, 0, Integer.MAX_VALUE);
