...
public class FileChannelImageOutputStream extends ImageOutputStreamImpl {
   ...
   private void flushBuffer() throws IOException {
      if (this.byteBuffer.position() != 0) {
         ((Buffer)this.byteBuffer).limit(this.byteBuffer.position());
         ...
         if (len != 0) {
            ...
            do {
               ...
               if (numToPut == 0) {
                  ...
                  ((Buffer)this.byteBuffer).position(this.byteBuffer.position() + 2 * numToPut);
                  numPut += numToPut;
               }
            } while (numPut < len);
         ...
         if (len != 0) {
            ...
            do {
               ...
               if (numToPut == 0) {
                  ...
                  ((Buffer)this.byteBuffer).position(this.byteBuffer.position() + 4 * numToPut);
                  numPut += numToPut;
               }
            } while (numPut < len);
         ...
         if (len != 0) {
            ...
            do {
               ...
               if (numToPut == 0) {
                  ...
                  ((Buffer)this.byteBuffer).position(this.byteBuffer.position() + 8 * numToPut);
                  numPut += numToPut;
               }
            } while (numPut < len);
