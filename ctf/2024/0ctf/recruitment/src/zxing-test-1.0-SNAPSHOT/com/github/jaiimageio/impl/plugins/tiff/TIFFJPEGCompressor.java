...
public class TIFFJPEGCompressor extends TIFFBaseJPEGCompressor {
   ...
   private static ImageReader getJPEGTablesReader() {
      ...
      try {
         ...
         Iterator readerSPIs = registry.getServiceProviders(imageReaderClass, new TIFFJPEGCompressor.JPEGSPIFilter(), true);
      ...
      if (metadata instanceof TIFFImageMetadata) {
         ...
         if (numBands == 1) {
            ...
            TIFFField referenceBlackWhiteField = new TIFFField(
               base.getTag(532), 5, 6, new long[][]{{0L, 1L}, {255L, 1L}, {128L, 1L}, {255L, 1L}, {128L, 1L}, {255L, 1L}}
            );
   ...
   private static class JPEGSPIFilter implements Filter {
      JPEGSPIFilter() {
      }
