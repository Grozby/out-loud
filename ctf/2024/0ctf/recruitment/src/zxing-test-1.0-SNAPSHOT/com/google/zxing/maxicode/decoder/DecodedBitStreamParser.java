...
final class DecodedBitStreamParser {
   ...
   private static final byte[] COUNTRY_BYTES = new byte[]{53, 54, 43, 44, 45, 46, 47, 48, 37, 38};
   private static final byte[] SERVICE_CLASS_BYTES = new byte[]{55, 56, 57, 58, 59, 60, 49, 50, 51, 52};
   private static final byte[] POSTCODE_2_LENGTH_BYTES = new byte[]{39, 40, 41, 42, 31, 32};
   private static final byte[] POSTCODE_2_BYTES = new byte[]{
      33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2
   };
   private static final byte[][] POSTCODE_3_BYTES = new byte[][]{
      {39, 40, 41, 42, 31, 32}, {33, 34, 35, 36, 25, 26}, {27, 28, 29, 30, 19, 20}, {21, 22, 23, 24, 13, 14}, {15, 16, 17, 18, 7, 8}, {9, 10, 11, 12, 1, 2}
   };
      ...
      for (int i = start; i < start + len; i++) {
         ...
         switch (c) {
            ...
            case '\ufffb':
               ...
               sb.append(new DecimalFormat("000000000").format((long)nsval));
         }
