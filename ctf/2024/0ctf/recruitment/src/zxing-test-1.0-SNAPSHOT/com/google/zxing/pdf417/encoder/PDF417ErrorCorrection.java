...
final class PDF417ErrorCorrection {
   private static final int[][] EC_COEFFICIENTS = new int[][]{
      {27, 917},
      {522, 568, 723, 809},
   ...
   static String generateErrorCorrection(CharSequence dataCodewords, int errorCorrectionLevel) {
      ...
      for (int i = 0; i < sld; i++) {
         ...
         for (int j = k - 1; j >= 1; j--) {
            int t2 = t1 * EC_COEFFICIENTS[errorCorrectionLevel][j] % 929;
            int t3 = 929 - t2;
            e[j] = (char)((e[j - 1] + t3) % 929);
         }

         int t2 = t1 * EC_COEFFICIENTS[errorCorrectionLevel][0] % 929;
         int t3 = 929 - t2;
         e[0] = (char)(t3 % 929);
      }
