...
public final class AddressBookParsedResult extends ParsedResult {
   ...
   public AddressBookParsedResult(
      String[] names, String[] phoneNumbers, String[] phoneTypes, String[] emails, String[] emailTypes, String[] addresses, String[] addressTypes
   ) {
   ...
   public AddressBookParsedResult(
      ...
      } else if (emails != null && emailTypes != null && emails.length != emailTypes.length) {
         throw new IllegalArgumentException("Emails and types lengths differ");
      } else if (addresses != null && addressTypes != null && addresses.length != addressTypes.length) {
